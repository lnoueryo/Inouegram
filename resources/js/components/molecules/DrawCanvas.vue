<template>
  <div>
    ...
    <div id="tool-area" style="position: relative;">
        ...
        <v-slider v-model="context.lineWidth"></v-slider>
        Options
Dot Size
Swatches Max Height
Mode
...
<v-color-picker
    ...
    ></v-color-picker><br><br><br><br><br><br><br>
        ...
        <button id="rotate-button" @click="rotate()">反転</button>
        <button id="reflection-button" @click="reflection">反映</button>
        <v-btn @click="$emit('click', concatImg)">submit</v-btn>
    </div>
...
export default {
  ...
  reflection(){
        ...
        this.concatImg = document.getElementById('concat').toDataURL('image/png');
    },
  createImage(context){
  var image= new Image
